...
whitespace_pretokenizer = pre_tokenizers.Whitespace()
...
tokenizer.pre_tokenizer = pre_tokenizers.Sequence([digits_pretokenizer, whitespace_pretokenizer, bytelevel_pretokenizer])
...
tokenizer_wrapper.push_to_hub("bigcode/tokenizer-ablations", revision="only-whitespace")