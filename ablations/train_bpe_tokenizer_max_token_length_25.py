...
trainer = BpeTrainer(vocab_size=VOCAB_SIZE, show_progress=True, special_tokens=SPECIAL_TOKENS, max_token_length=25)
...
tokenizer_wrapper.push_to_hub("bigcode/tokenizer-ablations", revision="max-token-length-25")